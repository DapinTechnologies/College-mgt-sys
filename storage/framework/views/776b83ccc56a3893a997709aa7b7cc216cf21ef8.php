                ...
                <div class="card">
                    ...
                    <form id="wizard-advanced-form" class="needs-validation" novalidate action="<?php echo e(route($route.'.store')); ?>" method="post" enctype="multipart/form-data" style="display: none;">
                      <?php echo csrf_field(); ?>
                        ...
                        <content class="form-step">
                            <!-- Form Start--->
                            <?php if(field('student_school_transcript')->status == 1 || field('student_school_certificate')->status == 1 || field('student_collage_transcript')->status == 1 || field('student_collage_certificate')->status == 1 || field('student_photo')->status == 1 || field('student_signature')->status == 1): ?>
                            <fieldset class="row scheduler-border">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\business\latest Dapin\backup\Dapin\stk -trial\Dapin\Dapin\resources\views/admin/student-transfer-in/create.blade.php ENDPATH**/ ?>