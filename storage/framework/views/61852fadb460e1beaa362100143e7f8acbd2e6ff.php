                        ...
                        <div class="card-block">
                            ...
                            <?php if(isset($director) && $director->image): ?>
                                <div class="mt-3">
                                    ...
                                    <div>
                                        <img src="<?php echo e(asset('storage/'.$director->image)); ?>" alt="Director Image" width="80">
                                    </div>
                                </div>
                            <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($director->image): ?>
                                            <img src="<?php echo e(asset('storage/'.$director->image)); ?>" alt="Director Image" width="100">
                                        <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\business\backup\Dapin\stk -trial\Dapin\Dapin\resources\views/admin/director/index.blade.php ENDPATH**/ ?>